...
Parks DH, Imelfort M, Skennerton CT, Hugenholtz P, Tyson GW. 2015. CheckM: assessing the quality of microbial genomes recovered from isolates, single cells, and metagenomes. Genome Research, 25: 1043–1055.
    ...
    GIT_COMMIT_HASH = "c9b4be62d8a95ffc487b697884b11cae8b55f21d"
    ...
    def run_checkM(self, ctx, params):
        ...
        :param params: instance of type "CheckMInputParams" (required params:
           ...
           genome file, should be "fna" workspace_name: the name of the
           workspace it gets saved to. optional params: thread: number of
           threads; default 1 external_genes: indicating an external gene
           call instead of using prodigal, default 0 external_genes_file: the
           file containing genes for gene call, default "") -> structure:
           parameter "workspace_name" of String, parameter
           "putative_genomes_folder" of String, parameter
           "checkM_workflow_name" of String, parameter "file_extension" of
           String, parameter "thread" of Long, parameter "external_genes" of
           type "boolean" (A boolean - 0 for false, 1 for true. @range (0,
           1)), parameter "external_genes_file" of String
