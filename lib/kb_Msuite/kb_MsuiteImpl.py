...
Parks DH, Imelfort M, Skennerton CT, Hugenholtz P, Tyson GW. 2015. CheckM: assessing the quality of microbial genomes recovered from isolates, single cells, and metagenomes. Genome Research, 25: 1043–1055.
    ...
    GIT_COMMIT_HASH = "9b898070ee966a30343140bdcc9f54c3775b6fe2"
    ...
    def run_checkM(self, ctx, params):
        ...
        :param params: instance of type "CheckMInputParams" (required params:
           bin_in_folder: folder path that holds all putative genome files
           with (fa as the file extension) to be checkM-ed bin_out_folder:
           folder path that holds all putative genome files with (fa as the
           file extension) to be checkM-ed checkM_cmd_name: name of the
           CheckM workflow,e.g., lineage_wf or taxonomy_wf workspace_name:
           ...
           be "fna" thread: number of threads; default 1 external_genes:
           indicating an external gene call instead of using prodigal,
           default 0 external_genes_file: the file containing genes for gene
           call, default "") -> structure: parameter "bin_in_folder" of
           String, parameter "bin_out_folder" of String, parameter
           "checkM_cmd_name" of String, parameter "workspace_name" of String,
           parameter "file_extension" of String, parameter "thread" of Long,
           parameter "external_genes" of type "boolean" (A boolean - 0 for
           false, 1 for true. @range (0, 1)), parameter "external_genes_file"
           of String
